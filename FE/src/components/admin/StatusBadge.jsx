...
const statusConfig = {
  ...
  completed: { color: 'bg-green-status/10 text-green-status', dot: 'bg-green-status', label: 'Hoàn tất' },
  fulfilled: { color: 'bg-green-status/10 text-green-status', dot: 'bg-green-status', label: 'Hoàn tất' },
  ...
  delivered: { color: 'bg-green-status/10 text-green-status', dot: 'bg-green-status', label: 'Đã giao' },
