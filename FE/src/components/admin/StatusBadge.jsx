...
const statusConfig = {
  ...
  pending_payment: { color: 'bg-tertiary-fixed/30 text-tertiary', dot: 'bg-tertiary' },
  failed: { color: 'bg-error-container text-error', dot: 'bg-error' },
  cancelled: { color: 'bg-error-container text-error', dot: 'bg-error' },
  completed: { color: 'bg-green-status/10 text-green-status', dot: 'bg-green-status' },
  fulfilled: { color: 'bg-green-status/10 text-green-status', dot: 'bg-green-status' },
